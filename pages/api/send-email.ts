...
function generateEmailTemplate(
  ...
  const footerHtml = `
      <div class="footer">
        <p>© 2026 Shivya's Nal Studio. All rights reserved.</p>
        <div>
          <a href="https://instagram.com/shivyasnalstudio" class="social-link">Instagram</a>
          <a href="https://pinterest.com/shivyasnalstudio" class="social-link">Pinterest</a>
          <a href="https://wa.me/1234567890" class="social-link">WhatsApp</a>
        </div>
        <p><a href="mailto:hello@shivyasnalstudio.com" style="color: #E6B7A9; text-decoration: none;">hello@shivyasnalstudio.com</a></p>
      </div>
      </div>
    </body>
    </html>
  ...
  if (templateType === 'booking-confirmation') {
    middleHtml = `
      <div class="header">
        ...
        <p>Thank you for choosing Shivya's Nal Studio</p>
      </div>
      <div class="content">
      ...
      <div class="content">
        ...
        <div class="detail-box">
          ...
          <div class="detail-row">
            ...
            <span class="detail-value">124 Atelier Row, Suite 400, New York, NY</span>
          </div>
          <div class="detail-row">
    ...
    middleHtml = `
      <div class="header">
        <h1>${data.title || "Message from Shivya's Nal Studio"}</h1>
      </div>
      <div class="content">
 ...
 *     subject: "Booking Confirmation - Shivya's Nal Studio",
