...
export const defaultSEO = {
  title: "Shivya's Nal Studio - Luxury Nail Art & Booking",
  description:
    "Book luxury nail art services online at Shivya's Nal Studio. Custom sets, gel extensions, and polished treatments with a services-first booking flow.",
  canonical: 'https://shivyasnalstudio.com',
  ogImage: 'https://shivyasnalstudio.com/og-image.jpg',
  twitterHandle: '@shivyasnalstudio',
  keywords: [
    'nail art',
    'nail salon',
    'gel manicure',
...
export function generateStructuredData(type = 'organization') {
  const baseUrl = process.env.NEXT_PUBLIC_APP_URL || 'https://shivyasnalstudio.com';
...
export function generateServiceSEO({
  ...
  return {
    title: `${serviceName} - Shivya's Nal Studio | Luxury Nail Services`,
